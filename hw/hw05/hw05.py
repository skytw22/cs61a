class VendingMachine:
    ...
    def add_funds(self, fund_amount):
        if self.stock == 0:
            return 'Inventory empty. Restocking required. Here is your ${0}.'.format(fund_amount)
        self.fund += fund_amount
...
def store_digits(n):
    ...
    if n < 10:
        ...
        while n > 10:
            ...
            power += 1
        rest = t % (10 ** power)
        return Link(n, store_digits(rest))
