...
def balanced(m):
    ...
    if is_planet(m):
        ...
        left_arm = end(left(m))
        right_arm = end(right(m))
        weight_left = total_weight(left_arm) * length(left(m))
        weight_right = total_weight(right_arm) * length(right(m))
        return weight_left == weight_right and balanced(left_arm) and balanced(right_arm)
