...
class Ant(Insect):
    ...
    def remove_ant(self, other):
        assert False, "{0} cannot remove an ant".format(self)
...
# BEGIN Problem 7
class WallAnt(Ant):
    """Wall Ant has large armor value so that it can add protection to
    the home. It does nothing each turn."""
    name = 'Wall'
    food_cost = 4
    implemented = True
...
# END Problem EC
    ...
    def action(self, gamestate):
        ...
        while place != None:
            if place.ant and place.ant not in self.buffed:
                place.ant.damage *= 2
